...
const brandAppleTouchIcon = "/assets/brand/apple-touch-icon.png";

function brandPicture({ className = "brand-logo", eager = false } = {}) {
  return `<picture class="${className}"><source srcset="${brandLogoSvg}" type="image/svg+xml"><img src="${brandLogoPng}" alt="NovaPharm Healthcare" width="2048" height="258"${eager ? ' fetchpriority="high"' : ' loading="lazy"'} decoding="async"></picture>`;
}

function privateHead(title) {
  return `<head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><meta name="theme-color" content="#E3120B"><title>${title}</title><link rel="icon" href="${brandFaviconSvg}" type="image/svg+xml"><link rel="icon" href="/assets/brand/favicon.ico" sizes="any"><link rel="apple-touch-icon" href="${brandAppleTouchIcon}" sizes="180x180"><link rel="stylesheet" href="/assets/css/novapharm.bundle.css"><script type="module" src="/assets/js/cookie-consent.js"></script><script src="/assets/js/local-validation-banner.js" defer></script></head>`;
}
