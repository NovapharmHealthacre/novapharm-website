...
function applicationShell({ area, page, title, body, navigation }) {
  ...
  return `<!DOCTYPE html><html lang="en-GB" data-api-base="${apiBase}"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><title>${title} | NovaPharm ${area}</title><link rel="stylesheet" href="/assets/css/novapharm.css"></head><body data-enterprise-page="${page}"><div class="portal-shell"><aside class="portal-sidebar"><a class="brand" href="${root}/dashboard/"><img src="/assets/Novapharm-logo.svg" alt="" width="42" height="42"><span><span class="brand-name">NovaPharm</span><span class="brand-meta">${area}</span></span></a><nav aria-label="${area} navigation">${links}${crossLinks}<button class="btn btn-outline" type="button" data-logout>Logout</button></nav></aside><main class="portal-main"><div class="portal-topbar"><div><span class="eyebrow">${area}</span><h1>${title}</h1></div><span class="status-pill">Signed in as <span data-user-name></span></span></div>${body}</main></div><script src="/assets/js/api-client.js" defer></script><script src="/assets/js/portal-app.js" defer></script><script src="/assets/js/enterprise-app.js" defer></script></body></html>`;
}
...
function executiveIndex() {
  ...
  return `<!DOCTYPE html><html lang="en-GB"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><title>Executive Platform | NovaPharm Healthcare</title><link rel="stylesheet" href="/assets/css/novapharm.css"></head><body><main class="portal-main"><div class="portal-topbar"><div><span class="eyebrow">Board workspace</span><h1>NovaPharm Executive Platform</h1></div><a class="btn btn-outline" href="/portal/" data-logout>Logout</a></div><div class="grid grid-3">${modules.map(([label, href]) => `<a class="card" href="${href}"><h2>${label}</h2><p>Open the controlled ${label.toLowerCase()} module.</p></a>`).join("")}</div></main><script src="/assets/js/api-client.js" defer></script><script src="/assets/js/portal-app.js" defer></script></body></html>`;
}
...
function adminPage(page, title, body) {
  ...
  return `<!DOCTYPE html><html lang="en-GB" data-api-base="${apiBase}"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><title>${title} | NovaPharm Admin</title><link rel="stylesheet" href="/assets/css/novapharm.css"></head><body><div class="portal-shell"><aside class="portal-sidebar"><a class="brand" href="/admin/dashboard/"><img src="/assets/Novapharm-logo.svg" alt="" width="42" height="42"><span><span class="brand-name">NovaPharm</span><span class="brand-meta">Admin</span></span></a><nav aria-label="Admin navigation">${links}<a href="/employee/dashboard/">Employee Portal</a><button class="btn btn-outline" type="button" data-logout>Logout</button></nav></aside><main class="portal-main"><div class="portal-topbar"><div><span class="eyebrow">Administration</span><h1>${title}</h1></div><span class="status-pill">Canonical data</span></div>${body}</main></div><script src="/assets/js/api-client.js" defer></script><script src="/assets/js/portal-app.js" defer></script><script src="/assets/js/admin-app.js" defer></script></body></html>`;
}

writeProtected("admin/index.html", '<!DOCTYPE html><html lang="en-GB"><head><meta charset="UTF-8"><meta http-equiv="refresh" content="0;url=/admin/dashboard/"><meta name="robots" content="noindex,nofollow"><title>Admin | NovaPharm</title></head><body><a href="/admin/dashboard/">Continue</a></body></html>', "admin");
