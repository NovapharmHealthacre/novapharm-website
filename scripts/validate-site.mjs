...
const requiredFiles = [
  ...
  "audit/business-plan-website-gap-analysis.md",
  "audit/current-website-oncology-ai-gap-review.md",
  "audit/oncology-public-claims-report.md",
  "audit/ai-public-claims-report.md",
  "audit/ai-performance-report.md",
  "audit/ai-evaluation-report.md",
  "audit/ai-safety-red-team.md",
  "audit/oncology-ai-red-team-report.md",
  "audit/ai-citation-report.md",
  "audit/oncology-ai-browser-report.md",
  "audit/oncology-ai-accessibility-report.md",
  ...
  "final-report/oncology-ai-owner-handoff.md",
  ...
  "docs/business-plan-public-evidence-register.md",
  "docs/business-plan-claim-register.json",
  "docs/oncology-insights-briefs.md",
  "docs/oncology-media-provenance.json",
  "docs/private-oncology-opportunity-register.schema.json",
  "docs/public-content-evidence-register.json",
  "docs/ai-model-register.json",
  "docs/ai-model-licence-review.md",
  "docs/ai-dependency-and-model-sbom.json",
  "docs/ai-use-case-register.json",
  "docs/ai-risk-register.md",
  "docs/ai-system-card.md",
  "research/oncology-source-register.json",
  "research/oncology-digital-benchmark-2026.md",
  "research/oncology-category-leader-scorecard.md",
  "research/ai-source-register.json",
  ...
  "src/content/oncology-content.mjs",
  "src/ai/content-chunker.mjs",
  "src/ai/keyword-index.mjs",
  "src/ai/semantic-worker.mjs",
  "src/ai/citation-resolver.mjs",
  "src/ai/policy-engine.mjs",
  "src/ai/model-registry.mjs",
  "src/ai/privacy-guard.mjs",
  "src/ai/search-controller.mjs",
  "src/core/ai/ai-gateway.mjs",
  "src/core/ai/provider-none.mjs",
  "src/core/ai/provider-ollama.mjs",
  "src/core/ai/retrieval-service.mjs",
  "src/core/ai/citation-service.mjs",
  "src/core/ai/policy-service.mjs",
  "src/core/ai/audit-service.mjs",
  "src/core/ai/redaction-service.mjs",
  "src/core/ai/model-registry.mjs",
  "src/core/ai/use-case-registry.mjs",
  ...
  "scripts/build-ai-knowledge-index.mjs",
  "scripts/test-oncology-content.mjs",
  "scripts/test-oncology-schema.mjs",
  "scripts/audit-oncology-ai-claims.mjs",
  "scripts/test-ai-index.mjs",
  "scripts/test-ai-citations.mjs",
  "scripts/test-ai-policy.mjs",
  "scripts/test-ai-privacy.mjs",
  "scripts/test-ai-model-licences.mjs",
  "scripts/test-ai-prompt-injection.mjs",
  "scripts/test-ai-no-js-fallback.mjs",
  "scripts/test-ai-performance.mjs",
