...
[
  ...
  [index, "pharma-home-shade", "Homepage directional contrast layer"],
  [index, "Medicine. Where it needs to be", "Homepage concise primary message"],
  [index, "Conceptual supply-chain visual. No NovaPharm facility, vehicle, inventory or current distribution activity is depicted.", "Homepage conceptual media boundary"],
  ...
  [index, "Evidence travels with the batch.", "Homepage Batch Integrity editorial heading"],
  [index, "Clarity before complexity.", "Homepage controlled-growth message"],
  [index, "Representative traceability composition. It is not a NovaPharm facility, product or active batch record.", "Homepage traceability media boundary"],
  ...
  [services, "module-signal-disclosure", "Services visible representative-media boundary"],
  ...
  [regulatory, "module-signal-disclosure", "Regulatory visible representative-media boundary"],
  ...
  [technology, "module-signal-disclosure", "Technology visible representative-media boundary"],
  ...
  [leadership, "/assets/vishalchakravarty.png", "Vishal approved portrait"],
  [leadership, "/assets/prabhakarvitthallahare.png", "Prabhakar approved portrait"],
  [leadership, "/assets/girishshantilalachliya.png", "Girish approved portrait"],
  [leadership, "module-portrait-composition", "Leadership tailored portrait composition"],
  [vishal, "/assets/vishalchakravarty.png", "Vishal profile portrait"],
  [prabhakar, "/assets/prabhakarvitthallahare.png", "Prabhakar profile portrait"],
  [girish, "/assets/girishshantilalachliya.png", "Girish profile portrait"],
  [css, "@media (prefers-reduced-motion: reduce)", "Reduced-motion support"],
  [publicCss, "--apple-pharma-public-contract: 3", "Scoped public Apple-pharma source contract"],
  ...
  [bundleCss, "--apple-pharma-public-contract: 3", "Bundled scoped Apple-pharma contract"],
