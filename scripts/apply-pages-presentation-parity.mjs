  ...
  <section class="pharma-section">
    <div class="container">
      ...
      <div class="pharma-focus-grid">
        <article><h3>Oncology &amp; specialty</h3><p>Closer control of formulation, continuity and evidence.</p><a href="/oncology/">Explore oncology continuity →</a></article>
        <article><h3>Regulatory &amp; quality</h3><p>Authorisation, QMS and vendor oversight before release.</p><a href="/regulatory-services/">Review regulatory services →</a></article>
        <article><h3>Technology &amp; traceability</h3><p>Governed accounts, documents, evidence and decision history.</p><a href="/technology/">Explore technology controls →</a></article>
      </div>
    </div>
  </section>
