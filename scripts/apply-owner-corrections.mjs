...
const oncologyGallery = `<section class="section oncology-editorial-gallery" data-reveal><div class="container"><div class="section-head"><span class="section-kicker">Oncology operating contexts</span><h2>Product, formulation and controlled handling must be read together.</h2><p>Licensed scientific imagery supports the page across product assessment, formulation analysis and condition-sensitive handling.</p></div><div class="oncology-editorial-grid"><figure><picture><source srcset="/assets/media/products/oncology-vial-handling.avif" type="image/avif"><source srcset="/assets/media/products/oncology-vial-handling.webp" type="image/webp"><img src="/assets/media/products/oncology-vial-handling.jpg" alt="Gloved laboratory professional handling a vial with a pipette in a controlled scientific setting" width="1600" height="900" loading="lazy" decoding="async"></picture><figcaption>Vial and product assessment context</figcaption></figure><figure><picture><source srcset="/assets/media/products/oral-liquid-formulation.avif" type="image/avif"><source srcset="/assets/media/products/oral-liquid-formulation.webp" type="image/webp"><img src="/assets/media/products/oral-liquid-formulation.jpg" alt="Gloved laboratory professional holding an amber glass bottle during liquid analysis" width="1600" height="900" loading="lazy" decoding="async"></picture><figcaption>Formulation and presentation assessment</figcaption></figure><figure><picture><source srcset="/assets/media/products/specialty-pharmacy-handling.avif" type="image/avif"><source srcset="/assets/media/products/specialty-pharmacy-handling.webp" type="image/webp"><img src="/assets/media/products/specialty-pharmacy-handling.jpg" alt="Gloved laboratory professional using a multichannel pipette during controlled sample analysis" width="1600" height="900" loading="lazy" decoding="async"></picture><figcaption>Controlled specialist-product handling</figcaption></figure></div></div></section>`;
