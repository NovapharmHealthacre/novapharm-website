...
Manual screenshot and keyboard-oriented review confirmed readable hero contrast, visible captions, usable mobile menu, stable focusable controls, no clipped text and no horizontal page overflow. At 320 × 568 both hero decisions are visible above the fold. Service scope and six FAQs remain native disclosure controls.
...
- Small-screen hero actions extending below the first 320-pixel viewport
