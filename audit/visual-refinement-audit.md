...
| 11 | Compliance guardrails | Retained B2B-only wording and the explicit statement that regulated wholesale supply has not commenced. No image caption or copy claims current stock, a NovaPharm-owned facility, an MHRA authorisation, NHS supply or a confirmed partner. |
