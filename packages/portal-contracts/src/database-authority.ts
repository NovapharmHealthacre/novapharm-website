...
export const currentRuntimeDatabaseAuthorityByModule = Object.freeze({
  ...
  "executive.product-master": ["products", "product_families", "product_variants", "batches"],
  "executive.nhs-data": [],
  "executive.plpi": [],
  "executive.pharmacovigilance": [],
  "executive.sourcing": ["suppliers", "organizations", "product_supplier_links", "purchase_orders", "products"],
  "executive.tenders": [],
