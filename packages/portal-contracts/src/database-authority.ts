...
export const currentRuntimeDatabaseAuthorityByModule = Object.freeze({
  ...
  "executive.sales-intelligence": ["customers", "products", "orders", "invoices", "supplier_invoices", "quality_complaints", "regulatory_cases", "crm_opportunities", "integration_events"],
  "executive.customer-analytics": ["customers", "products", "orders", "invoices", "supplier_invoices", "quality_complaints", "regulatory_cases", "crm_opportunities", "integration_events", "organizations"],
  "executive.product-master": ["customers", "products", "orders", "invoices", "supplier_invoices", "quality_complaints", "regulatory_cases", "crm_opportunities", "integration_events", "product_variants", "product_families", "batches"],
  "executive.nhs-data": [],
  "executive.plpi": [],
  "executive.pharmacovigilance": [],
  "executive.sourcing": ["customers", "products", "orders", "invoices", "supplier_invoices", "quality_complaints", "regulatory_cases", "crm_opportunities", "integration_events", "suppliers", "organizations", "product_supplier_links", "purchase_orders"],
  "executive.tenders": [],
  "executive.warehouse": ["customers", "products", "orders", "invoices", "supplier_invoices", "quality_complaints", "regulatory_cases", "crm_opportunities", "integration_events", "shipments"],
  "executive.service-levels": ["customers", "products", "orders", "invoices", "supplier_invoices", "quality_complaints", "regulatory_cases", "crm_opportunities", "integration_events", "shipments"],
  "executive.finance": ["customers", "products", "orders", "invoices", "supplier_invoices", "quality_complaints", "regulatory_cases", "crm_opportunities", "integration_events", "journal_entries", "journal_lines"],
  "executive.capital": [],
  "executive.microsoft-365": [],
  "executive.documents": ["customers", "products", "orders", "invoices", "supplier_invoices", "quality_complaints", "regulatory_cases", "crm_opportunities", "integration_events", "documents"],
  "executive.ai-technology": [],
  "executive.traceability": ["customers", "products", "orders", "invoices", "supplier_invoices", "quality_complaints", "regulatory_cases", "crm_opportunities", "integration_events", "inventory_movements", "batches"],
