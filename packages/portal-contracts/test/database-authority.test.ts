...
import { currentRuntimeDatabaseAuthorityByModule, noCurrentRuntimeDatabaseAuthorityReason } from "../src/database-authority";
...
test("direct authored overlays expose their lean table boundaries", () => {
