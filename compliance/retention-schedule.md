...
| Portal session | Login, expiry, logout or credential change | Default expiry after 8 hours; revoke earlier on logout, password change, account disablement or security response. | Security owner |
