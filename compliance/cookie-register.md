...
| `np_session` | NovaPharm | Secure HttpOnly cookie | Maintain the requested authenticated, role-scoped session | Strictly necessary | 8 hours by default, or earlier revocation | First party | No for requested portal service | None by itself |
