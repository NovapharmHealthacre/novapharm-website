    ...
    <footer className="site-footer">
      <div className="shell footer-primary">
        <div className="footer-brand">
          ...
          <p className="footer-status">Active UK company. Regulated wholesale supply has not commenced and remains subject to applicable authorisation.</p>
        </div>
        ...
        <nav aria-label="Legal links"><strong>Legal</strong><Link href="/trust-centre/">Trust centre</Link><Link href="/legal/privacy/">Privacy</Link><Link href="/legal/cookies/">Cookies</Link><Link href="/legal/terms/">Terms</Link><Link href="/legal/accessibility/">Accessibility</Link><CookieSettingsButton /></nav>
      </div>
