...
export const corporatePages: readonly CorporatePage[] = Object.freeze([
  ...
  page("trust-centre", "narrative", "Trust is a verified operating condition.", "The NovaPharm Trust Centre brings together the public evidence boundaries for corporate identity, pharmaceutical status, privacy, security, accessibility and service assurance.", [
    { kicker: "Corporate identity", title: "One active legal entity, stated without operational inference.", paragraphs: ["NOVAPHARM HEALTHCARE LTD is incorporated in England and Wales under company number 16716501. Incorporation confirms the company record; it does not confer a WDA(H), product licence, manufacturing authorisation, pharmacy status or authority to begin regulated wholesale supply."], source: { label: "Verify the Companies House record", href: "https://find-and-update.company-information.service.gov.uk/company/16716501" } },
    { kicker: "Assurance boundary", title: "Implemented, deployed and independently verified are different states.", paragraphs: ["NovaPharm publishes a capability as operational only when the relevant service, permission and evidence have been accepted in the managed environment. Repository controls, architecture and local validation do not by themselves prove Azure activation, Entra enforcement, live email delivery, SharePoint permissions, penetration testing or regulatory approval."], bullets: ["Repository evidence is labelled as repository evidence", "Managed-service activation requires live proof", "External approval remains external", "Unavailable functions stay hidden or fail closed"] },
    { kicker: "Security and privacy", title: "Protected systems are designed around server-side trust boundaries.", paragraphs: ["The target estate separates public applications, the secure portal and protected API. Authentication, role checks, organisation isolation, CSRF protection, session controls, private document authorisation and audit events are enforced by server-side contracts. Production secrets belong in Azure Key Vault or an approved protected input, never public code or browser storage."], source: { label: "Read the privacy notice", href: "/legal/privacy/" } },
    { kicker: "Pharmaceutical claims", title: "Third-party evidence is not attributed to NovaPharm.", paragraphs: ["Product, partner, facility, licence and logistics statements are reviewed against a controlled claims and evidence model. A supplier's authorisation, certificate, facility or capability does not become NovaPharm's. The public website remains corporate and B2B, does not invite patient ordering and does not provide medical or prescribing advice."], source: { label: "Review the regulatory roadmap", href: "/regulatory-services/" } },
    { kicker: "Inclusive access", title: "Accessibility is tested, reported and open to challenge.", paragraphs: ["NovaPharm targets WCAG 2.2 AA and tests keyboard access, focus, contrast, responsive layouts, reduced motion, forms and rendered states in Chromium and a Safari-compatible WebKit engine. Automated checks support but do not replace manual or independent review."], source: { label: "Read the accessibility statement", href: "/legal/accessibility/" } },
    { kicker: "Raise a concern", title: "Security, privacy and accessibility concerns have a controlled route.", paragraphs: ["Use the corporate contact route for a privacy, accessibility, security or factual-correction concern. Do not submit passwords, access tokens, patient-identifiable information, adverse-event information or confidential board documents through the general form."], source: { label: "Contact NovaPharm", href: "/contact/" } },
  ]),
