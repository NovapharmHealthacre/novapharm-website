...
const baseUrl = process.env["FOUNDER_BASE_URL"] ?? "http://127.0.0.1:4301";
...
console.log(`Founder browser acceptance passed: ${screenshots} screenshots, ${accessibilityRuns} Axe runs, 2 engines.`);
